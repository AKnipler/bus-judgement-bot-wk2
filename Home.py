...
def init_page():
    ...
    st.markdown(
        ...
        "2. In the Em Conversation tab, converse with Em. Only when you are finished the conversation click the `finish` button. You will not be able to undo this submission.\n"
